...
class URLGenerator implements IURLGenerator
{
	...
	public function imagePath(string $appName, string $file): string
	{
		...
		if (file_exists(\OC::$SERVERROOT . "/themes/$theme/apps/$appName/img/$file")) {
			...
			!file_exists(\OC::$SERVERROOT . "/themes/$theme/apps/$appName/img/$basename.svg")
			...
			!file_exists(\OC::$SERVERROOT . "/themes/$theme/core/img/$basename.svg")
			...
			$appPath && !file_exists($appPath . "/img/$basename.svg")
			...
			!file_exists(\OC::$SERVERROOT . "/core/img/$basename.svg")
